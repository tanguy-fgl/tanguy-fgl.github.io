...
export async function GET(context: any) {
  ...
  const items = await Promise.all(sortedPosts.map(async (post: any) => {
    ...
    return {
      ...
      content: `<blockquote>This rendering was automatically generated by Frosti Feed and may have formatting issues. For the best experience, please visit:<a href="${context.site}/blog/${slug}/">${context.site}/blog/${slug}/</a></blockquote> <![CDATA[${content}]]>`,
      customData: `
